...
class GaugeMin extends StatefulWidget {
  const GaugeMin({Key? key}) : super(key: key);

  @override
  State<GaugeMin> createState() => _GaugeMinState();
}

class _GaugeMinState extends State<GaugeMin> {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Query(
        options: QueryOptions(
          operationName: "GetMinDatapoint",
          document: gql("""
...
"""),
        ...
        builder: (QueryResult result,
          ...
          Map<String, dynamic>? datapoint = result.data?['minDatapoint'];
          if (datapoint == null) {
